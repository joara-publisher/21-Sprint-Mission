...
import { Textarea } from "./ItemFormStyles";
...
export const CommentFormButton = styled(DefaultButton)`
  float: right;
`;
...
export const CommentEmptyWrap = styled.div`
  font-weight: 400;
  font-size: 16px;
  line-height: 26px;
  color: var(--gray400);
...
export const CommentEmptyImg = styled.img`
  @media (max-width: 1199px) {
    width: 140px;
  }
`;
